...
## Project Structure
    ...
    ├── testapiautostorybo_105581  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_105581`
...
2. Clone this repo and `cd testapiautostorybo_105581`
